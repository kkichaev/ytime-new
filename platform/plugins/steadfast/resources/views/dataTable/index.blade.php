...
@if (!$isConfigComplete)
    ...
    <div class="alert alert-warning" style="max-width: 850px;margin: auto; z-index: 1055;">
        <div class="d-flex justify-content-between">
            <h5 class="text-danger">Invalid License</h5>
        </div>
        ...
        <div class="alert alert-info">
            ...
            <ol>
                <li>To purchase your license code, contact us via email at <a href="mailto:khairulkabir.dev@gmail.com">khairulkabir.dev@gmail.com</a> or visit our <a href="https://facebook.com/yourlink" target="_blank" class="text-primary">Facebook page</a>.</li>
                ...
                <li>On the settings page, enter your <strong>username</strong> and the <strong>license code</strong> you received after purchasing.</li>
