...
class EvPostTable extends TableAbstract
{
    use ForMember;
    ...
    public function setup(): void
    {
        $this
            ->model(Post::class)
            ->addHeaderAction(CreateHeaderAction::make()->url(route('public.member.ev-posts.create')))
            ->addColumns([
                CreatedAtColumn::make(),
                ImageColumn::make(),
                NameColumn::make()->route('public.member.ev-posts.edit'),
                FormattedColumn::make('categories_name')
                    ->title(trans('plugins/events-paces::posts.categories'))
                    ->width(150)
                    ->orderable(false)
                    ->searchable(false)
            ...
            ->addActions([
                EditAction::make()->route('public.member.ev-posts.edit'),
                DeleteAction::make()->route('public.member.ev-posts.destroy'),
            ])
            ->addBulkActions([
            ...
            ->addFilters([
                ...
                SelectBulkChange::make()
                    ->name('category')
                    ->title(trans('plugins/events-paces::ev-posts.category'))
                    ->searchable()
