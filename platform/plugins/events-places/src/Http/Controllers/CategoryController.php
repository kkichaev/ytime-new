...
use Botble\EventsPlaces\Forms\CategoryForm;
use Botble\EventsPlaces\Http\Requests\CategoryRequest;
...
class CategoryController extends BaseController
{
    protected function breadcrumb(): Breadcrumb
    {
        return parent::breadcrumb()
            ...
            ->add(trans('plugins/events-places::categories.menu'), route('ev-categories.index'));
    }

    public function index(Request $request)
    {
        $this->pageTitle(trans('plugins/events-places::categories.menu'));
    ...
    {
        $this->pageTitle(trans('plugins/events-places::ev-categories.create'));
    ...
    public function store(CategoryRequest $request)
    {
        ...
        return $response
            ->setPreviousRoute('ev-categories.index')
            ->setNextRoute('ev-categories.edit', $category->getKey())
    ...
    public function update(Category $category, CategoryRequest $request)
    {
        ...
        return $response
            ->setPreviousRoute('ev-posts.destroy')
    ...
    {
        if (! $model) {
            $form->setUrl(route('ev-categories.create'));
        }

        if (! Auth::guard()->user()->hasPermission('ev-categories.create') && ! $model) {
    ...
    {
        return array_merge([
            'canCreate' => Auth::guard()->user()->hasPermission('ev-categories.create'),
            'canEdit' => Auth::guard()->user()->hasPermission('ev-categories.edit'),
            'canDelete' => Auth::guard()->user()->hasPermission('ev-categories.destroy'),
            'createRoute' => 'ev-categories.create',
            'editRoute' => 'ev-categories.edit',
            'deleteRoute' => 'ev-categories.destroy',
